failures=0
if __workdir/ui/status.sh &> /dev/null ; then __workdir/ui/stop.sh || : $((failures++))  ; fi
if __workdir/gru/status.sh &> /dev/null ; then __workdir/gru/stop.sh || : $((failures++))  ; fi
if __workdir/livehandler/status.sh &> /dev/null ; then __workdir/livehandler/stop.sh || : $((failures++)) ; fi
